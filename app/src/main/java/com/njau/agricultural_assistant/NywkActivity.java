...
//右边按钮实现的功能逻辑\
        ...
        new Thread(new NywkActivity.NywkListThread()).start();
    }

    public class NywkListThread implements Runnable {

        public void run() {
            try {
                URL url = new URL("http://192.168.43.64:8080/springmvc_mybatis/nysplist");
            ...
            handler.post(new Runnable() {
                @Override
                public void run() {
                    SimpleAdapter simpleAdapter = new SimpleAdapter(NywkActivity.this,list1,
                    ...
                    listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                            ...
                            String url = yw.get("c_url").toString();
                            Intent intent=new Intent();
                            intent.setClass(NywkActivity.this,Video.class);
                            //利用bundle来存取数据
