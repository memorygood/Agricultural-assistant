...
public class SczxActivity extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        topbar.setOnLeftAndRightClickListener(new Topbar.OnLeftAndRightClickListener() {
            ...
            public void OnLeftButtonClick() {
                //左边按钮实现的功能逻辑
                finish();
                Intent intent = new Intent(SczxActivity.this, MainActivity.class);
...
//右边按钮实现的功能逻辑\
        ...
        new Thread(new SczxActivity.SczxListThread()).start();
    }
    public class SczxListThread implements Runnable {

        public void run() {
            try {
                URL url = new URL("http://192.168.43.64:8080/springmvc_mybatis/sczxlist");
            ...
            handler.post(new Runnable() {
                @Override
                public void run() {
                    SimpleAdapter simpleAdapter = new SimpleAdapter(SczxActivity.this,list1,
                    ...
                    listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                            ...
                            intent.setClass(SczxActivity.this,NewsDetail.class);
                            //利用bundle来存取数据
                            Bundle bundle=new Bundle();
                            bundle.putString("cid",cid);
                            bundle.putString("path","sczxxx");
                            bundle.putString("xxlx","sczxxx");
                            bundle.putString("activity","SczxActivity");
